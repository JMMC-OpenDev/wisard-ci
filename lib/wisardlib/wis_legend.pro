;+
; NAME:
;       WIS_LEGEND (from original LEGEND routine, adapted to WISARD for
;                   non-ambiguity)
; PURPOSE:
...
; CALLING SEQUENCE:
;       WIS_LEGEND [,items][,keyword options]
; EXAMPLES:
;       The call:
...
;-
pro wis_legend, items, BOTTOM_LEGEND=bottom, BOX = box, CENTER_LEGEND=center, $
