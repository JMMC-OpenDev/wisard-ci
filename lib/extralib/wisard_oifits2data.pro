FUNCTION WISARD_OIFITS2DATA, list_of_files, select_best_data=select_best_data, noflatten=noflatten, _EXTRA=ex
@ "wisard_common.pro"
...
data=wisard_build_data(a, noflatten=noflatten, _EXTRA=ex)
return,data
end
